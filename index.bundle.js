...
var TodoListController = /** @class */ (function () {
    function TodoListController(todoListModel, todoListView, projectListModel, projectListView) {
        ...
        this.modal = new _todo_views__WEBPACK_IMPORTED_MODULE_0__.TodoItemFormModalView().createViewElement(_util__WEBPACK_IMPORTED_MODULE_1__.DOMManipulation.getProjectTitles(this.projectListModel), function (todoItem) {
...
var TodoItemFormModalView = /** @class */ (function () {
    ...
    TodoItemFormModalView.prototype.createViewElement = function (projectList, addFunction) {
